	...
	<view class="seat-page">
		...
		<view class="seat-grid">
			...
			@tap="onSeatTap(seat)">
				...
				<uni-icons v-if="seat.hasSoket === 1" type="power" size="12" color="socket-icon"></uni-icons>
			</view>
		</view>
...
.seat-available { background: var(--color-accent, #547044); color: #fff; }
...
.footer { margin-top: 32rpx; display: flex; align-items: center; justify-content: space-between; }
.confirm-btn {
	background: var(--color-accent, #547044); color: #fff;
	border: 2rpx solid var(--color-ink, #29231D); border-radius: 8rpx; padding: 12rpx 32rpx;
}
</style>
